...
public class CalculosController {
	...
	@GetMapping(value = "/limpiar",produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<ResponseDto> limpiar() {
		ResponseDto response = calculoService.limpiar();
		return new ResponseEntity<>(response, HttpStatus.OK);
	}
