...
public class CalculoServiceImpl implements CalculoService {
	...
	public ResponseDto calcular(String operador) throws ScriptException {
		...
		String formula = null;
		/*
		 * Integer[] arregloNumeros = { 20, 2, 4, 2, 5 }; List<Integer> numeros =
		 * Arrays.asList(arregloNumeros); llenarOperandos(numeros);
		 */
		...
		if (operandos.size() > 0) {
			...
			response.setBody(Constantes.NO_OPERANDOS);
